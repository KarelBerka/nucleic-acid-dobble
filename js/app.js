...
const TRANSLATIONS = {
  cs: {
    ...
    feat_math_title: "Dobble",
    feat_math_desc: "Základním principem hry je, že libovolné dvě karty v balíčku sdílejí <strong>přesně jeden</strong> společný prvek. Úkolem hráčů je tuto shodu najít a pojmenovat dříve než soupeři!",
    ...
    ds_na_mini_tag: "q = 2 (7 symbolů / 7 karet)",
    ds_na_mini_title: "1. NA-Dobble Mini",
    ds_na_mini_desc: "Rychlá výuková sada určená pro začátečníky. Obsahuje 5 základních nukleových bází a 2 hlavní pentosy (D-ribózu a 2-deoxy-D-ribózu).",
    ds_na_full_tag: "q = 4 (21 symbolů / 21 karet)",
    ds_na_full_title: "2. Plná verze NA-Dobble",
    ds_na_full_desc: "Komplexní výuková sada pokrývající báze, nukleosidy, monofosfáty (AMP, CMP, UMP...), makroergické nukleotidy (ATP, GTP, cAMP) a modifikované báze tRNA.",
    ds_includes: "Klíčové symboly:",
  ...
  en: {
    ...
    feat_math_title: "Dobble",
    feat_math_desc: "The core principle of Dobble is that any two cards in the deck share <strong>exactly one</strong> matching item. Players race to find and name the matching symbol faster than opponents!",
    ...
    ds_na_mini_tag: "q = 2 (7 symbols / 7 cards)",
    ds_na_mini_title: "1. NA-Dobble Mini",
    ds_na_mini_desc: "Entry-level training deck designed for beginners. Contains 5 nitrogenous bases and 2 main pentoses (D-ribose & 2-deoxy-D-ribose).",
    ds_na_full_tag: "q = 4 (21 symbols / 21 cards)",
    ds_na_full_title: "2. Full NA-Dobble",
    ds_na_full_desc: "Comprehensive training deck covering bases, nucleosides, monophosphates (AMP, CMP...), energetic nucleotides (ATP, GTP, cAMP), and tRNA modifications.",
    ds_includes: "Key symbols:",
  ...
  de: {
    ...
    feat_math_title: "Dobble",
    feat_math_desc: "Das Grundprinzip des Spiels ist, dass zwei beliebige Karten im Deck <strong>genau ein</strong> gemeinsames Symbol teilen. Wer die Übereinstimmung zuerst findet, gewinnt!",
    ...
    ds_na_mini_tag: "q = 2 (7 Symbole / 7 Karten)",
    ds_na_mini_title: "1. NA-Dobble Mini",
    ds_na_mini_desc: "Schnelles Einsteiger-Deck mit 5 Stickstoffbasen und 2 wichtigen Pentosen (D-Ribose & 2-Deoxy-D-ribose).",
    ds_na_full_tag: "q = 4 (21 Symbole / 21 Karten)",
    ds_na_full_title: "2. Vollversion NA-Dobble",
    ds_na_full_desc: "Umfassendes Lern-Deck für Basen, Nukleoside, Nukleotide (ATP, GTP, cAMP) und tRNA-Modifikationen.",
    ds_includes: "Wichtige Symbole:",
  ...
  fr: {
    ...
    feat_math_title: "Dobble",
    feat_math_desc: "Le principe fondamental du jeu est que deux cartes quelconques du paquet partagent <strong>exactement un</strong> symbole commun. Trouvez la correspondance avant vos adversaires !",
    ...
    ds_na_mini_tag: "q = 2 (7 symboles / 7 cartes)",
    ds_na_mini_title: "1. NA-Dobble Mini",
    ds_na_mini_desc: "Jeu rapide d'initiation avec 5 bases azotées et 2 pentoses principales (D-ribose & 2-désoxy-D-ribose).",
    ds_na_full_tag: "q = 4 (21 symboles / 21 cartes)",
    ds_na_full_title: "2. Version complète NA-Dobble",
    ds_na_full_desc: "Jeu complet couvrant bases, nucléosides, nucléotides (ATP, GTP, cAMP) et modifications d'ARNt.",
    ds_includes: "Symboles clés :",
